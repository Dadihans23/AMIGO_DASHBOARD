...
const rowsData = [
  ...
  },
  {
    ...
    name: 'Jennifer Summers',
    email: 'tristin_johnson@gmail.com',
    totalPurchases: 375.50,
    cashbackPaid: 18.75,
  },
];

const TableUserCashback = () => {
  ...
  const handleViewDetails = (userId) => {
    router.push(`/amigo-dash/usercashback/${userId}`);
  };
...
export default TableUserCashback;